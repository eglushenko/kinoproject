...
public class TheMovieDbClientConfig {
    ...
    @Bean
    public RequestInterceptor authRequestInspector(@Value("${themoviedb.api.kay}") String apiKay) {
        return requestTemplate -> requestTemplate.header("Authorization", "Bearer " + apiKay);
    }
