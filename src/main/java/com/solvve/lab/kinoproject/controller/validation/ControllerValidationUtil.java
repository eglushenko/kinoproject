...
public class ControllerValidationUtil {
    ...
    public static <T extends Comparable<T>> void validateNotEquals(T value1, T value2,
                                                                   String fieldName, String field2Name) {
        if (value1.compareTo(value2) == 0) {
            throw new ControllerValidationException(String.format(" Field %s=%s should not equals %s=%s",
